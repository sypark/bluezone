...
public class CookieUtils {
	...
	public void createCookie(HttpServletRequest request, HttpServletResponse response, Integer custNo){
		Cookie cookie = new Cookie(CommonConstant.COOKIE_CUST_NO, custNo.toString());
